...
<body>
	<h2>이벤트 등록 페이지</h2>
	<form action="eventregister" method="POST" enctype="multipart/form-data">
	<!--  form action = "controller의 보낼 주소" -->

		<div>
			<p>이벤트명: </p>
			<input type= "text" name="eventName" placeholder= "이벤트명 입력" required>
		</div>
		<div>
			<p>이벤트 가격: </p>
			<input type="number" name="eventPrice" placeholder= "이벤트 가격 입력" required>
		</div>
